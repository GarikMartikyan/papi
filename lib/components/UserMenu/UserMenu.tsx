 ...
 *
 * Про пользователя ядро ничего не знает и нигде его не хранит: и данные, и
 * пункты приходят пропсами от панели. Слайса под это нет намеренно — состояние
 * пользователя появится вместе с авторизацией, а до тех пор заводить его
 * означало бы угадывать её форму.
 *
